...
public class StudentService {
    ...
    public void deleteStudent(Long studentId) {
        ...
        if (!existsById) {
            throw new IllegalStateException("student doesnt ont exist with id" + studentId);
        }
    ...
    public void updateStudent(Long studentId, String name, String email) {
        ...
        if (name != null && name
                .length() > 0 && !Objects.equals(name, student.getName())) {
            student.setName(name);
        }
        if (email != null && email
                .length() > 0 && !Objects.equals(email, student.getEmail())) {
